...
export default function UserProfile({ user }) {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white rounded-3xl p-6 text-gray-800">
      ...
      <button
        className="px-4 py-2 my-4 bg-sky-500 text-white rounded hover:bg-sky-600 transition duration-200 cursor-pointer min-w-3xs"
        onClick={() => logOut()}
      >
        Log out
      </button>
